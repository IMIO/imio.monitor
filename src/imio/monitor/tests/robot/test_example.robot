...
#
#  $ bin/test -s imio.monitor -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src imio.monitor.testing.IMIO_MONITOR_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/imio/monitor/tests/robot/test_example.robot
#
